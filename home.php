...
<head>
   ...
   <title>Vintage and Thrifted</title>
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide">
                  <div class="image">
                     <img src="images/BlackShirt.png" alt="">
                  </div>
                  <div class="content">
   ...
   <section class="category">
      ...
      <div class="swiper category-slider">
         ...
         <div class="swiper-wrapper">
            ...
            ?>
                  <a href="category.php?category_id=<?= $fetch_category['cate_id']; ?>" class="swiper-slide slide">
                     <img src="<?= $fetch_category['image']; ?>" alt="">
                     <h3><?= $fetch_category['title']; ?></h3>
                  </a>
            <?php
               }
            } else {
   ...
   <section class="home-products">
      ...
      <div class="swiper products-slider">
         ...
         <div class="swiper-wrapper">
            ...
            <?php
            $select_products = $conn->prepare("SELECT * FROM `furniture_product` LIMIT 3");
